...
from woocommerce_sync.woocommerce_requests import get_request
from woocommerce_sync.exceptions import WoocommerceSetupError

class WoocommerceSyncSettings(Document):
	def validate(self):
